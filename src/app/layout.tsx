...
export const metadata: Metadata = {
  metadataBase: new URL("https://approvedexpandables.com"),
  ...
  openGraph: {
    title: "Approved Expandable Homes",
    description: "Australian council approved Class 1a expandable homes, custom designed for your property.",
    url: "/",
    siteName: "Approved Expandable Homes",
    locale: "en_AU",
    type: "website",
